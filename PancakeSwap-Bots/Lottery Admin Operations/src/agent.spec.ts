...
describe("PancakeSwap Lottery", () => {
  ...
  beforeAll(() => {
    ...
    eventInterface = new ethers.utils.Interface([EVENTS.NewRandomGenerator, EVENTS.NewOperatorAndTreasuryAndInjectorAddresses])

    functionInterface = new ethers.utils.Interface(ABI)

    eventLog_1 = eventInterface.encodeEventLog(
    ...
    eventLog_2 = eventInterface.encodeEventLog(
