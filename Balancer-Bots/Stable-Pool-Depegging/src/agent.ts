...
import { ethers, Finding, getEthersProvider, Initialize, HandleBlock, BlockEvent, HandleTransaction, TransactionEvent} from "forta-agent";
...
export const provideHandleTransaction = (config: AgentConfig, provider: ethers.providers.Provider): HandleTransaction => {
