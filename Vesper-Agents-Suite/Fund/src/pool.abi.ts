const abi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string", name: "_symbol", type: "string" },
      { internalType: "address", name: "_token", type: "address" },
      { internalType: "address", name: "_poolAccountant", type: "address" },
  ...
  {
    inputs: [{ internalType: "uint256", name: "_loss", type: "uint256" }],
    name: "reportLoss",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "_lastRebalance", type: "uint256" },
      { internalType: "uint256", name: "_totalDebt", type: "uint256" },
      { internalType: "uint256", name: "_totalLoss", type: "uint256" },
  ...
  {
    inputs: [
      { internalType: "address", name: "_proposedGovernor", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_newPoolRewards", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_newWithdrawFee", type: "uint256" },
    ],
