...
const CASES: TestData = [
  // not pairs
  [createAddress("0xace17e"), createAddress("0xa1"), createAddress("0xa2"), createAddress("0xfefe"), "Mint", [createAddress('0x1a'), "1000", "2000"], "1000", "2000", false, 1], 
  [createAddress("0xca1d0"),createAddress("0xa3"), createAddress("0xa4"),  createAddress("0xfefe"), "Burn", [createAddress('0x1b'), "2000", "3000", createAddress('0x2b')], "100", "200", false, 2], 
  // under threshold
  [createAddress("0xf11e7e"), createAddress("0xa23"), createAddress("0xa32"),createAddress("0xf11e7e"), "Mint", [createAddress('0x1c'), "1", "1"], "200", "200", false, 3], 
  [createAddress("0xc0c1d0"),  createAddress("0xa5"), createAddress("0xa6"), createAddress("0xc0c1d0"), "Burn", [createAddress('0x1b'), "10", "3", createAddress('0x2b')], "4000", "200", false, 4],
  // over threshold
  [createAddress("0xe570fad0"), createAddress("0xa85"), createAddress("0xa86"), createAddress("0xe570fad0"), "Mint", [createAddress('0x1e'), "100", "200"], "10", "20", true, 5], 
  [createAddress("0xfee"),createAddress("0xa95"), createAddress("0xa96") ,createAddress("0xfee"), "Burn", [createAddress('0x1f'), "200", "40", createAddress('0x2f')], "1000", "200", true, 6], 
  // other events on pairs
  [createAddress("0x1ce"),createAddress("0xa75"), createAddress("0xa76"), createAddress("0x1ce"), "Test", ["1", "2"], "10", "20", false, 7], 
  [createAddress("0xf00d"),createAddress("0xa65"), createAddress("0xa66"), createAddress("0xf00d"), "Test", ["3", "4"], "1000", "200", false, 8], 
];
...
describe("Large add/remove Liquidity agent tests suite", () => {
  ...
  it("should detect/ignore events accordingly", async () => {
    for(let [address, token0,token1,realPair, event, params, reserve0, reserve1, emitFinding, block] of CASES) {
      ...
      mockProvider.addCallTo(address,block -1,abi.PAIR,"getReserves",{inputs:[],outputs:[BigNumber.from(reserve0),BigNumber.from(reserve1),BigNumber.from(0)]});
  ...
  it("should detect multiple events", async () => {
    ...
    for(let [address,token0,token1,realPair, event, params, reserve0, reserve1,emitFinding,] of EVENTS) {
       ...
       // add call to getReserves. 
       mockProvider.addCallTo(address,block -1,abi.PAIR,"getReserves",{inputs:[],outputs:[BigNumber.from(reserve0),BigNumber.from(reserve1),0]});
