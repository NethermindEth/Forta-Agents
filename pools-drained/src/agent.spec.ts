...
const createFinding = (...addrs: string[]) =>
  Finding.fromObject({
...
describe("Pool drained test suite", () => {
  ...
  it("should allow 1 transfer on V2 mint calls", async () => {
    ...
    const tx: TransactionEvent = new TestTransactionEvent()
      .setBlock(block)
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), t0, [pair, createAddress("0x1"), 10])
      .addTraces({
        to: pair,
        input: abi.V2_IFACE.encodeFunctionData(abi.V2_IFACE.getFunction("mint"), [createAddress("0x2")]),
      });
  ...
  it("should allow 1 transfer on V2 burn calls", async () => {
    ...
    const tx: TransactionEvent = new TestTransactionEvent()
      .setBlock(block)
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), t0, [pair, createAddress("0x1231"), 1])
      .addTraces({
        to: pair,
        input: abi.V2_IFACE.encodeFunctionData(abi.V2_IFACE.getFunction("burn"), [createAddress("0x3")]),
      });
  ...
  it("should allow 1 transfer on V2 swap calls", async () => {
    ...
    const tx: TransactionEvent = new TestTransactionEvent()
      .setBlock(block)
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), t0, [createAddress("0xdef1"), pair, 555])
      .addTraces({
        to: pair,
        input: abi.V2_IFACE.encodeFunctionData(abi.V2_IFACE.getFunction("swap"), [1, 2, createAddress("0x3"), "0x00"]),
      });
  ...
  it("should allow 1 transfer on V2 skim calls", async () => {
    ...
    const tx: TransactionEvent = new TestTransactionEvent()
      .setBlock(block)
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), t0, [createAddress("0xdef1"), pair, 66])
      .addTraces({
        to: pair,
        input: abi.V2_IFACE.encodeFunctionData(abi.V2_IFACE.getFunction("skim"), [createAddress("0xd1fa1")]),
      });
  ...
  it("should allow 2 transfer on V2 flash loans", async () => {
    ...
    const tx: TransactionEvent = new TestTransactionEvent()
      .setBlock(block)
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), t1, [createAddress("0xdef1"), pair, 5])
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), t1, [pair, createAddress("0xd"), 4])
      .addTraces({
        to: pair,
        input: abi.V2_IFACE.encodeFunctionData(abi.V2_IFACE.getFunction("swap"), [
          10,
          22,
          createAddress("0x3"),
          "0x01",
  ...
  it("should allow 1 transfer on V3 mint calls", async () => {
    ...
    const tx: TransactionEvent = new TestTransactionEvent()
      .setBlock(block)
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), t0, [pair, createAddress("0x11"), 101])
      .addTraces({
        to: pair,
        input: abi.V3_IFACE.encodeFunctionData(abi.V3_IFACE.getFunction("mint"), [
          createAddress("0x2"),
          1,
          2,
          3,
  ...
  it("should allow 1 transfer on V3 burn calls", async () => {
    ...
    const tx: TransactionEvent = new TestTransactionEvent()
      .setBlock(block)
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), t0, [pair, createAddress("0x111"), 1011])
      .addTraces({
        to: pair,
        input: abi.V3_IFACE.encodeFunctionData(abi.V3_IFACE.getFunction("burn"), [2, 3, 4]),
      });
  ...
  it("should allow 1 transfer on V3 collect calls", async () => {
    ...
    const tx: TransactionEvent = new TestTransactionEvent()
      .setBlock(block)
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), t1, [pair, createAddress("0x112"), 1021])
      .addTraces({
        to: pair,
        input: abi.V3_IFACE.encodeFunctionData(abi.V3_IFACE.getFunction("collect"), [
          createAddress("0x22"),
          3,
          4,
          5,
  ...
  it("should allow 1 transfer on V3 swap calls", async () => {
    ...
    const tx: TransactionEvent = new TestTransactionEvent()
      .setBlock(block)
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), t0, [pair, createAddress("0x1123"), 10213])
      .addTraces({
        to: pair,
        input: abi.V3_IFACE.encodeFunctionData(abi.V3_IFACE.getFunction("swap"), [
          createAddress("0x223"),
          true,
          33,
          43,
  ...
  it("should allow 2 transfer on V3 flash calls", async () => {
    ...
    const tx: TransactionEvent = new TestTransactionEvent()
      .setBlock(block)
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), t1, [pair, createAddress("0x6"), 7])
      .addTraces({
        to: pair,
        input: abi.V3_IFACE.encodeFunctionData(abi.V3_IFACE.getFunction("flash"), [
          createAddress("0x8"),
          9,
          10,
          "0x11",
      ...
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), t1, [createAddress("0x12"), pair, 13]);
  ...
  it("should detect irregular transfers", async () => {
    ...
    const v3 = {
      ...
      fee: 4,
      pair: utils.v3Create2(createAddress("0x2"), createAddress("0x3"), 4),
    };
    const v2 = {
      t0: createAddress("0x6"),
      t1: createAddress("0x7"),
      pair: utils.v2Create2(createAddress("0x6"), createAddress("0x7")),
    };
    ...
    const tx: TransactionEvent = new TestTransactionEvent()
      .setBlock(block)
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), v3.t0, [v3.pair, createAddress("0x8"), 9])
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), v3.t0, [v3.pair, createAddress("0x10"), 11])
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), v3.t1, [createAddress("0x12"), v3.pair, 13])
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), v3.t0, [createAddress("0x14"), v3.pair, 15])
      .addTraces({
        to: v3.pair,
        input: abi.V3_IFACE.encodeFunctionData(abi.V3_IFACE.getFunction("mint"), [
          createAddress("0x16"),
      ...
      .addTraces({
        to: v3.pair,
        input: abi.V3_IFACE.encodeFunctionData(abi.V3_IFACE.getFunction("burn"), [21, 22, 23]),
      })

      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), v2.t1, [createAddress("0x88"), v2.pair, 99])
      .addInterfaceEventLog(abi.TRANSFER_IFACE.getEvent("Transfer"), v2.t1, [createAddress("0x888"), v2.pair, 999])
      .addTraces({
        to: v2.pair,
        input: abi.V2_IFACE.encodeFunctionData(abi.V2_IFACE.getFunction("skim"), [createAddress("0x1616")]),
      });
