...
export const createFinding = (initialBCV: string, newBCV: string, adjustment: string, addition: string): Finding => {
  return Finding.fromObject({
    name: "Bond Contract ControlVariableAdjustment Event",
    description: "A ControlVariableAdjustment event was emitted from a bond contract",
