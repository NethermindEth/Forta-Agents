...
describe("Contracts developed by contracts agent test suit", () => {
    ...
    it("Should report only the contract that deploy other contracts", async () => {
      ...
      expect(findings).toStrictEqual([
        Finding.fromObject({
          ...
          description: `Contract (0x2) develop the new contract (0x3)`,
        ...
        Finding.fromObject({
          name: "Contract developed by a contract",
          description: `Contract (0x3) develop the new contract (0x4)`,
          alertId: "NETHFORTA-07",
          type: FindingType.Suspicious,
          severity: FindingSeverity.Info,
        }),
