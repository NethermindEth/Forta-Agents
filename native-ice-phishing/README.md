...
This bot monitors transactions in which the receiver is an EOA and the input data is the hash of a known function signature.
...
- NIP-1
  ...
  - Metadata contains:
    - `attackerAddress`: The receiver of the transaction
