...
describe("Liquidation Alert Agent", () => {
  ...
  it("should return a Finding from Kill event emission", async () => {
    ...
    // NOTE: CHOSE RANDOM ADDRESSES FROM Etherscan FOR THE
    // testKillers AND testOwners TO PASS "bad address checksum",
    // SINCE WE CAN'T CONTROL WHAT ADDRESSES ARE FUNCTION ARGUMENTS
