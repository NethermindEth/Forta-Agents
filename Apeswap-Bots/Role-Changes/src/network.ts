...
const BSC_MAINNET_DATA: NetworkData = {
  ...
  miniApeV2: "0x0000000000000000000000000000000000000000", //contract doesn't exist on BSC
  miniComplexRewarderTime: "0x0000000000000000000000000000000000000000", //contract doesn't exist on BSC
};
...
const POLYGON_MAINNET_DATA: NetworkData = {
  masterApe: "0x0000000000000000000000000000000000000000", //contract doesn't exist on Polygon
  masterApeAdmin: "0x0000000000000000000000000000000000000000", //contract doesn't exist on Polygon
