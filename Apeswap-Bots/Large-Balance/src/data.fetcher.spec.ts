...
//   function createMockBalanceCall(account: string, apeswapAddress: string, blockNumber: number, balanceCall: BigNumber) {
//     return mockProvider.addCallTo(apeswapAddress, blockNumber, APESWAP_INTERFACE, "balanceOf", {
//       inputs: [account],
//       outputs: [balanceCall],
//     });
//   }
...
//       const fetcher: DataFetcher = new DataFetcher(apeswapAddress, mockProvider as any);
