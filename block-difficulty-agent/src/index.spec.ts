...
describe("Test difficulty change agent", () => {
    ...
    const blockHandler: HandleBlock = provideHandleBlock(mockBlockDifficultyGetter, NUMBER_OF_BLOCK_TO_TEST);
    ...
    it("should return finding if difficulty increases too much", async () => {
        ...
        expect(findings).toStrictEqual([Finding.fromObject({
            ...
            description: `Block number ${blockToCheck} made an unusual difficulty change`,
            alertId: "NETHFORTA-8",
