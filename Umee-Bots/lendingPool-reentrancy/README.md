...
```
npm run block 31767753
```

In the block `31767753`, `ReentrancyCallForLendingPool.attack()` is executed. It will create a reentrant call on the `deposit` transaction and a finding will be emitted.
